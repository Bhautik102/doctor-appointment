...
import 'package:block1/exceptions/firebaseauth/credential_actions_exceptions.dart';
import 'package:block1/exceptions/firebaseauth/reauth_exceptions.dart';
import 'package:block1/exceptions/firebaseauth/signin_exceptions.dart';
...
class AuthentificationService {
  ...
  Future<bool> signUp({String email, String password,UserType userType,String name}) async {
    try {
      final UserCredential userCredential = await firebaseAuth
      ...
      await UserDatabaseHelper().createNewUser(uid,userType.name,displayName);
      return true;
    } on MessagedFirebaseAuthException {
      rethrow;
    } on FirebaseAuthException catch (e) {
